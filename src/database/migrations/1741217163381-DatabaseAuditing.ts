...
export class DatabaseAuditing1741217163381 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "sto_info_app"."_audit_login_attempts" ("id" SERIAL NOT NULL, "email" character varying(255), "ipAddress" character varying, "success" boolean NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_6e3a438f7c8f1a3ce530fec0a12" PRIMARY KEY ("id"))`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `DROP TABLE "sto_info_app"."_audit_login_attempts"`,
    );
