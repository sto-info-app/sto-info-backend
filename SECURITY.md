...
- Additional active overrides for `mailparser`/`nodemailer`, `nanoid`, `qs`, TypeORM's optional `ioredis` peer, and `ts-jest`'s optional Babel peer remain documented in `docs/security.md`, including their upstream removal criteria.
